...
document.getElementsByName("player_question").innerHTML = "Question Turn  -" + player_1_name;
document.getElementsByName("player_answer").innerHTML = "Anser Turn  -" + player_2_name;
...
function send(){
    ...
    input_box = <br>Answer  :  <input type='text' id='input_cleck_box'>;
